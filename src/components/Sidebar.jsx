      ...
      <div className="md:p-4 md:border-b md:border-border">
        ...
        <div className="hidden md:flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold text-foreground">Codex CLI UI</h1>
        ...
        <div className="md:hidden p-3 border-b border-border">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-semibold text-foreground">Codex CLI UI</h1>
          ...
          {isLoading ? (
            <div className="text-center py-12 md:py-8 px-4">
              ...
              <p className="text-sm text-muted-foreground">
                Fetching your Codex projects and sessions
              </p>
            </div>
          ) : projects.length === 0 ? (
            <div className="text-center py-12 md:py-8 px-4">
              ...
              <p className="text-sm text-muted-foreground">
                Run Codex CLI in a project directory to get started
              </p>
            </div>
