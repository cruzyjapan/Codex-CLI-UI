...
function MainContent({ 
  ...
  onNavigateToSession,    // Navigate to a specific session (for Codex CLI session duplication workaround)
      ...
      <div className="h-full flex flex-col" style={{ minHeight: '100vh' }}>
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center text-gray-500 dark:text-gray-400">
            ...
            <h2 className="text-xl font-semibold mb-2">Loading Codex CLI UI</h2>
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center text-gray-500 dark:text-gray-400 max-w-md mx-auto px-6">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
              Select a project from the sidebar to start coding with Codex. Each project contains your chat sessions and file history.
            </p>
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 flex flex-col min-h-0 overflow-hidden">
        ...
        <div className={`h-full overflow-hidden ${activeTab === 'files' ? 'block' : 'hidden'}`}>
          <FileTree selectedProject={selectedProject} isActive={activeTab === 'files'} />
        </div>
